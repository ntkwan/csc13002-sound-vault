...
function AdminSongPage() {
    ...
    const [removeSongById] = useRemoveSongByIdMutation();
    ...
    const [deactivateSong] = useDeactivateSongMutation();
    ...
    const [activateSong] = useActivateSongMutation();

        ...
        <div className="w-screen h-screen flex justify-center items-center">
            <div className="w-[370px] bg-transparent">
                ...
                <div className="flex mt-6 space-x-2">
                    ...
                    <button onClick={signin} className="flex-1 flex items-center justify-center h-[49px] bg-[#383838] rounded-[12px] text-[#fcfcfc] shadow-md hover:opacity-75 cursor-pointer">
                        <span className="font-kodchasan text-[13.5px]">Sign in</span>
                    </button>
                </div>
